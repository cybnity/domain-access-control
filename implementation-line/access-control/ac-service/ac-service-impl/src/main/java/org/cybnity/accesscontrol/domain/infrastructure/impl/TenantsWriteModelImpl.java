 ...
 */
public class TenantsWriteModelImpl implements ITenantsWriteModel {
    ...
    private static ITenantsWriteModel singleton;
     ...
     */
    public static ITenantsWriteModel instance(IDomainStore<Tenant> persistenceLayer) throws IllegalArgumentException {
        if (singleton == null) {
