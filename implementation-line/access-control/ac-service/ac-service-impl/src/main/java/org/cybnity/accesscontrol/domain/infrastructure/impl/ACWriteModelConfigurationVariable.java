...
/**
 * Enumeration defining a set of variables regarding a WriteModel of the Access Control (AC) domain object types (e.g Tenant).
 * <p>
 ...
 * @author olivier
 */
public enum ACWriteModelConfigurationVariable implements IReadableConfiguration {
    /**
     * Default duration in seconds relative to each snapshot resource of AC perimeter that are saved into a snapshot repository.
     */
    AC_WRITEMODEL_SNAPSHOT_ITEM_DEFAULT_EXPIRATION_DURATION_IN_SECONDS("AC_WRITEMODEL_SNAPSHOT_ITEM_DEFAULT_EXPIRATION_DURATION_IN_SECONDS");
     ...
     */
    private ACWriteModelConfigurationVariable(String aName) throws IllegalArgumentException {
