...
This page presents the configuration to apply manually via the Keycloak administration web console.

By the way, those configuration elements are programmatically generated by the **ac-adapter-keycloak-admin-impl** module (see `RealmDefaultComplementaryResourcesHelper` class).
