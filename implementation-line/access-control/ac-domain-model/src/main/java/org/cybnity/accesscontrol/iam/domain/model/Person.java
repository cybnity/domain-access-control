...
public class Person extends SocialEntity {
    ...
    /**
     * Default constructor.
     * During the construction, a PERSON_CREATED domain event is automatically added to the lifecycle changes history container.
     *
    ...
    public Person(Entity predecessor, Identifier id) throws IllegalArgumentException {
        ...
        try {
            ...
            ConcreteDomainChangeEvent changeEvt = prepareChangeEventInstance(DomainEventType.PERSON_CREATED);
     ...
     */
    public static Person instanceOf(Identifier instanceId, List<DomainEvent> changesHistory) throws IllegalArgumentException {
        ...
        // Normally, any event relative to a person change shall include specification attributes allowing its instantiation
        if (HydrationAttributeProvider.class.isAssignableFrom(event.getClass())) {
            ...
            // Read identification of person mandatory predecessor entity reference
            if (parentId != null && tenantId != null && occurredAt != null) {
                ...
                Person fact = new Person(parent, tenantId /* re-hydrated domain data identity privileged from event attributes*/);
        ...
        throw new IllegalArgumentException("Impossible re-hydration of person instance from changes history!");
    }
    ...
    public void mutateWhen(DomainEvent change) throws IllegalArgumentException {
        ...
        // Only about change event (DomainEventType.PERSON_CREATED or DomainEventType.PERSON_DELETED not managed as mutation to apply)
        // if (DomainEventType.PERSON_CHANGED.name().equals(change.type().value())) {
    ...
    public Serializable immutable() throws ImmutabilityException {
        ...
        person.occurredAt = this.occurredAt();
        return person;
    }
