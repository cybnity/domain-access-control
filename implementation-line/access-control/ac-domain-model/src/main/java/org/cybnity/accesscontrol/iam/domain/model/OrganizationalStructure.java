...
public class OrganizationalStructure extends SocialEntity {
    ...
    /**
     * Default constructor.
     * During the construction, a ORGANIZATIONAL_STRUCTURE_CREATED domain event is automatically added to the lifecycle changes history container.
     *
    ...
    public OrganizationalStructure(Entity predecessor, Identifier id) throws IllegalArgumentException {
        ...
        try {
            ...
            ConcreteDomainChangeEvent changeEvt = prepareChangeEventInstance(DomainEventType.ORGANIZATIONAL_STRUCTURE_CREATED);
    ...
    public static OrganizationalStructure instanceOf(Identifier instanceId, List<DomainEvent> changesHistory) throws IllegalArgumentException {
        ...
        // Normally, any event relative to an organizational structure change shall include specification attributes allowing its instantiation
        if (HydrationAttributeProvider.class.isAssignableFrom(event.getClass())) {
            ...
            // Read identification of organizational structure mandatory predecessor entity reference
            if (parentId != null && tenantId != null && occurredAt != null) {
                ...
                OrganizationalStructure fact = new OrganizationalStructure(parent, tenantId /* re-hydrated domain data identity privileged from event attributes*/);
        ...
        throw new IllegalArgumentException("Impossible re-hydration of organizational structure instance from changes history!");
    }
    ...
    public void mutateWhen(DomainEvent change) throws IllegalArgumentException {
        ...
        // Only about change event (DomainEventType.ORGANIZATIONAL_STRUCTURE_CREATED or DomainEventType.ORGANIZATIONAL_STRUCTURE_DELETED not managed as mutation to apply)
        // if (DomainEventType.ORGANIZATIONAL_STRUCTURE_CHANGED.name().equals(change.type().value())) {
    ...
    public Serializable immutable() throws ImmutabilityException {
        ...
        organization.occurredAt = this.occurredAt();
        return organization;
    }
