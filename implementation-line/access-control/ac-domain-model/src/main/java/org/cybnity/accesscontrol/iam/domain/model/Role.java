...
/**
 * Role managed into a context (e.g; that could be assigned to an account about a system type, a user type, a function).
 * Role that can include permissions (e.g; read, modify, delete of information) relative to a domain scope.
 *
 * @author olivier
 */
public class Role extends MutableProperty {
    ...
    /**
     * Keys set regarding the multiple attribute defining this role, and that each change need to be versioned/treated as a single atomic fact.
     */
     ...
     * Default constructor.
     *
     * @param roleOwner Mandatory owner of this role (e.g; user account entity), including the entity information.
     * @param name      Mandatory label naming this role.
     * @throws IllegalArgumentException When mandatory parameter is missing.
     * @throws ImmutabilityException    When impossible creation of immutable version regarding the owner instance.
     */
    public Role(EntityReference roleOwner, String name)
     ...
     *                                  parameter.
     */
    private Role(Entity propertyOwner, HashMap<String, Object> propertyCurrentValue, HistoryState status)
    ...
    /**
     * Implement the generation of version hash regarding this class type according to a concrete strategy utility service.
     */
    @Override
     ...
     *
     * @return The owner.
     * @throws ImmutabilityException If impossible creation of immutable version of instance.
     */
